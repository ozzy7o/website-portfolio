...
function addItems() {
  ...
  createItem(300, 150,  'poison');
  createItem(230, 410,  'star');
  createItem(670, 105,  'star');
}
...
function addPlatforms() {
  ...
  platforms.create(150, 350, 'platform2');
  platforms.create(325, 450, 'platform');
...
window.onload = function () {
  ...
  function preload() {
    ...
    //Load spritesheets
    game.load.spritesheet('player', 'chalkers.png', 64, 62);
